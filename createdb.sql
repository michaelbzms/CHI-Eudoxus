...
-- Schema sdi1500102
-- -----------------------------------------------------
DROP SCHEMA IF EXISTS `sdi1500102` ;

-- -----------------------------------------------------
-- Schema sdi1500102
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `sdi1500102` DEFAULT CHARACTER SET utf8mb4 ;
USE `sdi1500102` ;

-- -----------------------------------------------------
-- Table `sdi1500102`.`USERS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sdi1500102`.`USERS` ;

CREATE TABLE IF NOT EXISTS `sdi1500102`.`USERS` (
...
-- -----------------------------------------------------
-- Table `sdi1500102`.`SECRETARIES`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sdi1500102`.`SECRETARIES` ;

CREATE TABLE IF NOT EXISTS `sdi1500102`.`SECRETARIES` (
  `idUser` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_idSecretary`
    FOREIGN KEY (`idUser`)
    REFERENCES `sdi1500102`.`USERS` (`idUser`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sdi1500102`.`STUDENTS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sdi1500102`.`STUDENTS` ;

CREATE TABLE IF NOT EXISTS `sdi1500102`.`STUDENTS` (
  `idUser` INT UNSIGNED NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_STUDENTS_SECRETARIES1`
    ...
    REFERENCES `sdi1500102`.`SECRETARIES` (`idUser`)
    ON DELETE SET NULL
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sdi1500102`.`PUBLISHERS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sdi1500102`.`PUBLISHERS` ;

CREATE TABLE IF NOT EXISTS `sdi1500102`.`PUBLISHERS` (
  `idUser` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `sdi1500102`.`DISTRIBUTION_POINTS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sdi1500102`.`DISTRIBUTION_POINTS` ;

CREATE TABLE IF NOT EXISTS `sdi1500102`.`DISTRIBUTION_POINTS` (
  `idUser` INT UNSIGNED NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `sdi1500102`.`BOOKS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sdi1500102`.`BOOKS` ;

CREATE TABLE IF NOT EXISTS `sdi1500102`.`BOOKS` (
  ...
  CONSTRAINT `fk_BOOKS_PUBLISHERS1`
    ...
    REFERENCES `sdi1500102`.`PUBLISHERS` (`idUser`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sdi1500102`.`DISTRIBUTION_POINTS_has_BOOKS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sdi1500102`.`DISTRIBUTION_POINTS_has_BOOKS` ;

CREATE TABLE IF NOT EXISTS `sdi1500102`.`DISTRIBUTION_POINTS_has_BOOKS` (
  ...
  CONSTRAINT `fk_DISTRIBUTION_POINTS_has_BOOKS_DISTRIBUTION_POINTS1`
    ...
    REFERENCES `sdi1500102`.`DISTRIBUTION_POINTS` (`idUser`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_DISTRIBUTION_POINTS_has_BOOKS_BOOKS1`
    FOREIGN KEY (`BOOKS_id`)
    REFERENCES `sdi1500102`.`BOOKS` (`idBook`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sdi1500102`.`ANNOUNCEMENTS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sdi1500102`.`ANNOUNCEMENTS` ;

CREATE TABLE IF NOT EXISTS `sdi1500102`.`ANNOUNCEMENTS` (
...
-- -----------------------------------------------------
-- Table `sdi1500102`.`GLOBAL_SEARCH`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sdi1500102`.`GLOBAL_SEARCH` ;

CREATE TABLE IF NOT EXISTS `sdi1500102`.`GLOBAL_SEARCH` (
...
-- -----------------------------------------------------
-- Table `sdi1500102`.`UNIVERSITY_CLASSES`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sdi1500102`.`UNIVERSITY_CLASSES` ;

CREATE TABLE IF NOT EXISTS `sdi1500102`.`UNIVERSITY_CLASSES` (
...
-- -----------------------------------------------------
-- Table `sdi1500102`.`BOOK_DECLARATION`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sdi1500102`.`BOOK_DECLARATION` ;

CREATE TABLE IF NOT EXISTS `sdi1500102`.`BOOK_DECLARATION` (
  ...
  CONSTRAINT `fk_BOOK_DECLARATION_STUDENTS1`
    ...
    REFERENCES `sdi1500102`.`STUDENTS` (`idUser`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `sdi1500102`.`BOOK_CLASS_TUPLES`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sdi1500102`.`BOOK_CLASS_TUPLES` ;

CREATE TABLE IF NOT EXISTS `sdi1500102`.`BOOK_CLASS_TUPLES` (
  ...
  CONSTRAINT `fk_BOOK_CLASS_TUPLES_BOOK_DECLARATION1`
    ...
    REFERENCES `sdi1500102`.`BOOK_DECLARATION` (`idDeclaration`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_BOOK_CLASS_TUPLES_UNIVERSITY_CLASSES1`
    FOREIGN KEY (`UNIVERSITY_CLASSES_id`)
    REFERENCES `sdi1500102`.`UNIVERSITY_CLASSES` (`idClass`)
    ON DELETE CASCADE
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `sdi1500102`.`UNIVERSITY_CLASSES_has_BOOKS`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `sdi1500102`.`UNIVERSITY_CLASSES_has_BOOKS` ;

CREATE TABLE IF NOT EXISTS `sdi1500102`.`UNIVERSITY_CLASSES_has_BOOKS` (
  `UNIVERSITY_CLASSES_id` INT UNSIGNED NOT NULL,
  `BOOKS_id` INT UNSIGNED NOT NULL,
