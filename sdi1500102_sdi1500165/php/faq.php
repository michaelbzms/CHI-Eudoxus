    ...
    <div class="main-container">
        ...
        <div class="m-2 text_div">
            ...
            <div class="tab-content">
                ...
                <div class="tab-pane p-3 fade" id="distPoint">
                    <div id="accordionDistPoint">
                        <div class="card">
                            <div class="card-header">
                                <a class="collapsed card-link" data-toggle="collapse" href="#collapse1DistPoint">
                                    Τι πρέπει να προσέξω για την ασφάλειά μου;
                                </a>
                            </div>
                            <div id="collapse1DistPoint" class="collapse">
                                <div class="card-body text-justify">
