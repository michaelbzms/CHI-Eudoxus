...
<body>
    <div class="main-container">
        ...
        <nav class="my_breadcrump">
            ...
            <p class="breadcrump_item">Σημεία Διανομής</p> > 
            <a class="breadcrump_item last_item" href="/sdi1500102_sdi1500165/php/help_distPoint.php">Βοήθεια Σημείου Διανομής</a>
        </nav>
        <div class="row justify-content-center">
            <div class="col-10 m-2 text_div">
                <h2>Βοήθεια Σημείου Διανομής</h2>
                <br>
                <h3>Λειτουργία: Παράδοση Συγγραμμάτων</h3>       
                <p> 
